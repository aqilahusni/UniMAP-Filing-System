...
</head><body bgcolor=c0c078>
<ul class="topnav">
  <li><a class="active" href="show">Home</a></li>
  <li><a href="addfile">Add New File</a></li>
  <?php
	if ($_SESSION['user']=="admin"){
	echo"<li><a href='reg'>Add New User</a></li>";}
  ?>
  <li class="right"><a href="out">Logout</a></li>
</ul>
<center>
<?php
session_start();
...
echo "<h2>Editing labels</h2><form  method=post name=tncedit action='edtlbls.php' >";
