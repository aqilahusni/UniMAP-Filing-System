...
<option value ='LIKE' selected>Seperti</option></option>
<option value ='>'>Lebih daripada</option>
<option value ='<'>Kurang daripada</option>
</select>

<input type=text name="value4comparison"></td>
<td><button class='button' name="B1"><span>Search </span></button></td>
</tr>
</table></form>
</center>
...
echo "<center><h2>Senarai Fail</h2>";
...
//echo "<br><a href='index.php'>Add New File</a>";
?> 
